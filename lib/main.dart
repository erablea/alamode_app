...
class PaintSmearPainter extends CustomPainter {
  ...
  Path _blob(double w, double h, {double ox = 0, double oy = 0}) {
    return Path()
      ...
      ..cubicTo(ox + w * -0.02, oy + h * 0.10, ox + w * 0.24, oy + h * -0.06,
          ox + w * 0.46, oy + h * 0.11)
      ..cubicTo(ox + w * 0.58, oy + h * 0.02, ox + w * 0.82, oy + h * -0.02,
          ox + w * 0.96, oy + h * 0.28)
      ..cubicTo(ox + w * 1.06, oy + h * 0.52, ox + w * 1.02, oy + h * 0.82,
          ox + w * 0.78, oy + h * 0.96)
      ..cubicTo(ox + w * 0.60, oy + h * 1.06, ox + w * 0.30, oy + h * 1.08,
          ox + w * 0.12, oy + h * 0.90)
      ..cubicTo(ox + w * -0.02, oy + h * 0.76, ox + w * 0.06, oy + h * 0.60,
          ox + w * 0.06, oy + h * 0.48)
      ..close();
  }
